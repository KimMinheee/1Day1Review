package com.programmers.OneDayOneReview.global.advice;
...
import com.programmers.OneDayOneReview.global.response.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    protected ResponseEntity<ErrorResponse> handleBindException(BindException e) {
        ...
        com.programmers.OneDayOneReview.global.response.ErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE_ERROR, e.getBindingResult());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    /**
     * [Exception] 커스텀 예외 - NotFoundException
     */
    ...
    /**
     * [Exception] 커스텀 예외 - PermissionDeniedException
     */
